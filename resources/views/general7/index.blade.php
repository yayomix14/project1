    ...
    <div class="media">
        ...
        <div id="tablaRegistros" class="media-body">
            ...
            <div class="col-md-12" style="margin-bottom:5%;">
                {{ Form::open(array('url' => 'general7', 'method' => 'GET','role'=>'search')) }}
                <div class="col-md-6">
              ...
              <table class="table">
                ...
                @foreach($querys as $query)    
                    <tr>
                        ...
                        <td>
                        <a href="/general7/edit/{{$query->id}}" class="btn btn-xs "><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> 
                        <a href="/general7/destroy/{{$query->id}}" onclick="return pregunta_eliminar(this)" class="btn btn-xs"><i class="fa fa-trash-o" aria-hidden="true"></i></a> 
                        <a href="/general7_pdf/{{$query->id}}" onclick="return pregunta_pdf(this)" class="btn  btn-xs"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></a></td>
                    </tr>
                    @endforeach
              </table>
          {!!$querys->render()!!}
