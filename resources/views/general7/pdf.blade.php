...
<legend><b>INCUDEF</b></legend>
  ...
  <div style="position: absolute; margin-left: -600px;">
    <div><b style="font:120%;margin-left:-100px">Sistema Estadal de Registro de Diversidad Cultural</b></div>
     <div><b style="font:100%;margin-left:-30px">Artes Visuales del Estado Falcón</b></div>    
  </div>
</fieldset>
...
<br>
 {{--  <div><b>Fecha de Registro: </b>{{$query_pdf->fecha}}</div>
  ...
  <div><b>Tallerista: </b>{{$query_pdf->tallerista}}</div>
...
<tr>
    ...
    <td colspan="2"><strong>Codigo de Registro:</strong>{{$query_pdf->codigo}}</td>
</tr>
<tr>
    <td colspan="1"><strong>Disciplina:</strong>{{$query_pdf->diciplina}}</td>
    <td colspan="2"><strong>Categoria:</strong>{{$query_pdf->categoria}}</td>
...
<tr>
    ...
    <td colspan="2"><strong>Fecha de Nacimiento: </strong>{{$query_pdf->fecha_n}}</td>
    <td colspan="3"><strong>Edad: </strong>{{$query_pdf->edad}}</td>
</tr>
<tr>
...
<tr>
    ...
    <td colspan="2"><strong>Participante de Asociaciòn:</strong>{{$query_pdf->partcipante}}</td>
    <td colspan="3"><strong>Tiempo de Trayectoria:</strong>{{$query_pdf->trayectoria}}</td>
</tr>
<tr>
    <td colspan="1"><strong>Nombre de la Asociaciòn:</strong>{{$query_pdf->asociacion}}</td>
    <td colspan="2"><strong>Tallerista:</strong>{{$query_pdf->tallerista}}</td>
</tr> 
<tr>
<tr>
    <td colspan="3"><strong>Especificaciòn de la Actividad que Realiza:</strong>{{$query_pdf->actividad}}</td></tr>
</tr>
</table>
