...
<br>
{{--   <div><b>Fecha de Registro: </b>{{$querys_pdf->fecha}}</div>
  <div><b>Codigo de Registro: </b>{{$querys_pdf->codigo}}</div>
  <div><b>Nombre: </b>{{$querys_pdf->nombre}}</div>
  <div><b>Nombre de Representante: </b>{{$querys_pdf->nombre_r}}</div>
  <div><b>RIF: </b>{{$querys_pdf->rif}}</div>
  <div><b>Direcciòn: </b>{{$querys_pdf->direccion}}</div>
  <div><b>Descripción del Espacio: </b>{{$querys_pdf->descripcion}}</div>
  <div><b>Titularidad: </b>{{$querys_pdf->titularidad}}</div>
  <div><b>Tiempo de Creada: </b>{{$querys_pdf->fecha_n}}</div>
  <div><b>Tipo de Colección: </b>{{$querys_pdf->tipo}}</div>
  <div><b>Municipio: </b>{{$querys_pdf->municipios_nombre}}</div>
  <div><b>Parroquia: </b>{{$querys_pdf->parroquias_nombre}}</div>
  <div><b>Telefono: </b>{{$querys_pdf->telefono}}</div>
  <div><b>Email: </b>{{$querys_pdf->email}}</div>
  <div><b>Nombre de Asociación: </b>{{$querys_pdf->asociacion}}</div>
  <div><b>Telefono de Referencia: </b>{{$querys_pdf->telefono_r}}</div>
  <div><b>Correo de Representante: </b>{{$querys_pdf->email_r}}</div>
  <div><b>Condiciòn Actual: </b>{{$querys_pdf->condicion}}</div>
  <div><b>Servicio: </b>{{$querys_pdf->servicio}}</div>
  <div><b>Paredes de: </b>{{$querys_pdf->paredes}}</div>
  <div><b>Techo de: </b>{{$querys_pdf->techo}}</div>
  <div><b>Piso de: </b>{{$querys_pdf->piso}}</div> --}}
...
<table cellspacing="0" style="width: 100%;">
 ...
 <tr>
     <td colspan="3"><strong>Descripción del Espacio:</strong>{{$query_pdf->descripcion}}</td>
    </tr>
 <tr>
    </tr>
 <tr>
     <td colspan="1"><strong>Nombre de la Asociación:</strong>{{$query_pdf->asociacion}}</td>
     <td colspan="2"><strong>Tipo de Colección:</strong>{{$query_pdf->tipo}}</td>
    </tr>
 <tr>
    ...
    <tr>
      ...
      <td colspan="2"><strong>Fecha de Creada:</strong>{{$query_pdf->fecha_n}}</td>
    </tr>
    <tr>
