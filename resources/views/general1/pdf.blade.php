...
<table cellspacing="0" style="width: 100%;">
    ...
    <tr>
      <td><strong>Representante del Municipio: </strong>{{$query_pdf->representante}}</td>
      <td><strong>Municipio: </strong>{{$query_pdf->municipios_nombre}}</td>
      <td><strong>Parroquia: </strong>{{$query_pdf->parroquias_nombre}}</td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="3"><strong>Dirección de Oficina:</strong>{{$query_pdf->oficina}}</td>
    </tr>
    <tr>
      <td colspan="1"><strong>Telefono de Oficina:</strong>{{$query_pdf->n_oficina}}</td>
      <td colspan="2"><strong>Email de Oficina:</strong>{{$query_pdf->email_oficina}}</td>
    </tr>
</table>
@endforeach
