...
<head>
	<meta charset="UTF-8">
	<title>Reporte por Mineral | CORPOFALCÓN</title>
	<style type="text/css">
...
<legend><b>CORPOFALCÓN</b></legend>
	...
	<div style="position: absolute; margin-left: -600px;">
		...
		<div><b>Reporte por Municipio</b></div>
		<div><b>Fecha Desde: <?php echo e(date('d/m/Y',strtotime($desde))); ?> Hasta: <?php echo e(date('d/m/Y',strtotime($hasta))); ?></b></div>
	...
	<?php foreach($querys as $query): ?>
	  <tr>
	    ...
	    <?php endif; ?>
	    	<th><?php echo e($query->total_mineral); ?></th>
	  </tr>
	  		<tr style="font-weight: bold; font-size: 9pt;">
	  			...
	  			<th></th>
	  			<th></th>
				<th style="text-align: left;">TOTAL GENERAL:   <?php echo e(number_format($query->total_minerals, 0, '', '.').' Bs'); ?></th>
			</tr>
	<?php endforeach; ?>
	  </tbody>
	</table>
