...
<br>
  ...
  <div><b>Municipio: </b><?php echo e($query_pdf->municipio); ?></div>
  <div><b>Parroquia: </b><?php echo e($query_pdf->parroquia); ?></div>
  ...
  <div><b>Condiciòn Actual: </b><?php echo e($query_pdf->condicion); ?></div>
   <div><b>Participante de Asociación: </b><?php echo e($query_pdf->participante); ?></div>
