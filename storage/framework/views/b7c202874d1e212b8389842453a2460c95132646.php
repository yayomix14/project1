...
<br>
 ...
 <table cellspacing="0" style="width: 100%;">
   ...
   <tr>
      <td colspan="3"><strong>RIF:</strong><?php echo e($query_pdf->rif); ?></td>
    </tr>
    <tr>
 ...
 <tr>
    ...
    <tr>
      <td colspan="1"><strong>OtroTelefono de Contacto:</strong><?php echo e($query_pdf->telefono_r); ?></td>
      <td colspan="2"><strong>OtroEmail de Contacto:</strong><?php echo e($query_pdf->email_r); ?></td>
    </tr>
    <tr>
      <td colspan="1"><strong>Condicion Actual:</strong><?php echo e($query_pdf->actual); ?></td>
      <td colspan="2"><strong>Tiempo de Trayectoria:</strong><?php echo e($query_pdf->trayectoria); ?></td>
    </tr>
    <tr>
      <td colspan="1"><strong>Fecha de Fundada:</strong><?php echo e($query_pdf->fecha_n); ?></td>
      <td colspan="2"><strong>Datos de Registro Legal:</strong><?php echo e($query_pdf->datos); ?></td>
    </tr>
