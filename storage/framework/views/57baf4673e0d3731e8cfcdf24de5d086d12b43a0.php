...
<div class="col-xs-9">
	...
	<div class="well">
		...
		<?php echo Form::open(['route'=>'mineral.store','method'=>'POST','role'=>'form','class'=>'form-horizontal']); ?>
			  ...
			  <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
				<div class="input-group">
				  ...
				  <span class="input-group-btn">
			        <button class="btn btn-success btn-secondary" type="submit"><span class="glyphicon glyphicon-file"></span> Agregar Mineral</button>
			      </span>
				</div>
