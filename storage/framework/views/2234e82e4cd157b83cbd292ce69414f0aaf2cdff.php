  ...
  <div class="well sidebar-nav">
              ...
              <?php if(Auth::user()->tipo == 'admin'): ?>
                ...
                <li class=""><b>Reportes</b></li>
                  <li><a href="<?php echo e('lol'); ?>"><i class='glyphicon glyphicon-th-list'></i>Mineral</a></li>
                  <li><a href="<?php echo e('lol'); ?>"><i class='glyphicon glyphicon-th-list'></i> Municipio</a></li>
                  <li><a href="<?php echo e('lol'); ?>"><i class='glyphicon glyphicon-th-list'></i> Picadora de piedra</a></li>
              <?php endif; ?>
              </ul>
            </div><!--/.well -->
  </div>
