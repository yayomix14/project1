...
<script type="text/javascript"> function fecha(){ var meses = new Array ("Enero","Febrero","Marzo","Abril","Mayo","Junio","Julio","Agosto","Septiembre","Octubre","Noviembre","Diciembre"); var diasSemana = new Array("Domingo","Lunes","Martes","Miércoles","Jueves","Viernes","Sábado"); var f=new Date(); document.write(diasSemana[f.getDay()] + " " + f.getDate() + " de " + meses[f.getMonth()] + " de " + f.getFullYear()); }</script>
  ...
  <?php echo e(Html::image('img/ejemplo.png', 'a picture', array('class' => 'pull-right','thumb','heigth'=>"100", "width"=>'160'))); ?>
  ...
  <div class="well sidebar-nav">
              ...
              <?php endif; ?>
                ...
                <li class=""><b>Menú General</b></li>
                  <li><a href="<?php echo e(URL::to('/general1')); ?>"><i class='fa fa-bars'></i> Coordinadores Municipales </a></li>
                  <li><a href="<?php echo e(URL::to('/general2')); ?>"><i class='fa fa-bars'></i> Infraestructura de Activación Cultural  </a></li>
                  <li><a href="<?php echo e(URL::to('/general3')); ?>"><i class='fa fa-bars'></i> Museos de Estado </a></li>
                  <li><a href="<?php echo e(URL::to('/general4')); ?>"><i class='fa fa-bars'></i> Asociaciones y Fundaciones  </a></li>
                  <li><a href="<?php echo e(URL::to('/general5')); ?>"><i class='fa fa-bars'></i> Artes Escènicas  </a></li>
                  <li><a href="<?php echo e(URL::to('/general6')); ?>"><i class='fa fa-bars'></i> Artesan@  </a></li>
                  <li><a href="<?php echo e(URL::to('/general7')); ?>"><i class='fa fa-bars'></i> Artes Visuales  </a></li>
                  <li><a href="<?php echo e(URL::to('/general8')); ?>"><i class='fa fa-bars'></i> Expreciones Literarias  </a></li>
                  <li><a href="<?php echo e(URL::to('/general9')); ?>"><i class='fa fa-bars'></i> Imprenta y Editorales  </a></li>
                  <li><a href="<?php echo e(URL::to('/general')); ?>"><i class='fa fa-bars'></i> Animación y Recreación  </a></li>
                  <li><a href="<?php echo e(URL::to('/general11')); ?>"><i class='fa fa-bars'></i> Saberes Tradicionales  </a></li>
                   <li><a href="<?php echo e(URL::to('/general12')); ?>"><i class='fa fa-bars'></i> Centros Audiovisuales, Televisoras y Radios  </a></li>

                
              </ul>
              <ul class="nav nav-list">
                <li><b>Reportes</b></li>
                <li><a href="<?php echo e(URL::to('/reporte')); ?>"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Consulta de Reportes</a></li>
              </ul>
            </div><!--/.well -->
  </div>
<?php endif; ?>
