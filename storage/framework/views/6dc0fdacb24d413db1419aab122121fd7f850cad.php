...
<div class="col-lg-9" style="text-align: center">
    ...
    <div class="media">
        ...
        <legend>Registro</legend>
            ...
            <?php echo Form::model($id,['route'=>['general4.update',$id->id],'role'=>'form','class'=>'form-horizontal','method'=>'PUT']); ?>

                <?php echo $__env->make('general4.form.form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
