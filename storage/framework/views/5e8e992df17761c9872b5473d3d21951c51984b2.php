...
<?php /*   <div><b>Fecha de Registro: </b><?php echo e($query_pdf->fecha); ?></div>
  ...
  <div><b>Desempeño: </b><?php echo e($query_pdf->desempeño); ?></div>
  ...
  <div><b>Participante de Asociación: </b><?php echo e($query_pdf->partcipante); ?></div>
...
<table cellspacing="0" style="width: 100%;">
    ...
    <tr>
      <td colspan="3"><strong>Desempeño: </strong><?php echo e($query_pdf->desempeño); ?></td>
      </tr>
    <tr>
    ...
    <tr>
      <td colspan="1"><strong>Condicion Actual:</strong><?php echo e($query_pdf->condicion); ?></td>
      <td colspan="2"><strong>Participante:</strong><?php echo e($query_pdf->partcipante); ?></td>
    </tr>
    <tr>
      <td colspan="1"><strong>Tiempo de Trayectoria:</strong><?php echo e($query_pdf->trayectoria); ?></td>
      <td colspan="2"><strong>Nombre de la Asociación:</strong><?php echo e($query_pdf->asociacion); ?></td>
    </tr>
    <tr>
    <td colspan="3"><strong>Especificación de Actividad que Realiza:</strong><?php echo e($query_pdf->actividad); ?></td></tr>
</table>
  <?php endforeach; ?>
</body>
</html>