...
<head>
	<meta charset="UTF-8">
	<title>Reporte por Actividades Conexas | CORPOFALCÓN</title>
	<style type="text/css">
...
<legend><b>CORPOFALCÓN</b></legend>
	...
	<table style="width:100%; font-size: 10px;">
	  <tr>
	    ...
	    <th style="border: 0.5px solid #000;">Modalidad</th>
	    <th style="border: 0.5px solid #000;">Estado Establecimiendo</th>
	...
	<?php foreach($querys as $query): ?>
	  <tr>
	    ...
	    <th><?php echo e($query->modalidad); ?></th> 
	    <th><?php echo e($query->e_establecimiento); ?></th>
