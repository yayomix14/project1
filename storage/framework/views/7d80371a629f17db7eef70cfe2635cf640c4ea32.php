...
<div class="input-group">
    <span class="input-group-addon">Descrpciòn del Espacio</span>
...
<div class="input-group">
     <span class="input-group-addon">Estdo Actual</span>
...
<div class="input-group">
    ...
    <span class="input-group-addon">Agua</span>  
            <?php echo Form::checkbox('servicio', 'agua',false); ?>

    <span class="input-group-addon">Luz</span>  
            <?php echo Form::checkbox('servicio', 'luz',false); ?>

    <span class="input-group-addon">Agua Servida</span>  
            <?php echo Form::checkbox('servicio', 'agua_s',false); ?>

    <span class="input-group-addon">Aseo Urbano</span>  
            <?php echo Form::checkbox('servicio', 'aseo',false); ?>
