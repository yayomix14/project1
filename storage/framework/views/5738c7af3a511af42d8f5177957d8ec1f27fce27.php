    ...
    <div class="media">
        ...
        <div id="tablaRegistros" class="media-body">
            ...
            <div class="col-md-12" style="margin-bottom:5%;">
                <?php echo e(Form::open(array('url' => 'general1', 'method' => 'GET','role'=>'search'))); ?>
                ...
                <div class="col-md-5">
                    <a href="/general1/create" class="btn pull-right"><i class="fa fa-plus" aria-hidden="true"></i> Nuevo Registro</a>
                </div>
                <?php echo Form::close(); ?>
              ...
              <table class="table">
                ...
                <?php foreach($querys as $query): ?>    
                    <tr>
                        ...
                        <td>
                        <a href="/general1/edit/<?php echo e($query->id); ?>" class="btn btn-xs "><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> 
                        <a href="/general1/destroy/<?php echo e($query->id); ?>" onclick="return pregunta_eliminar(this)" class="btn btn-xs"><i class="fa fa-trash-o" aria-hidden="true"></i></a> 
                        <a href="/general1_pdf/<?php echo e($query->id); ?>" onclick="return pregunta_pdf(this)" class="btn  btn-xs"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></a></td>
                    </tr>
                    <?php endforeach; ?>
              </table>
